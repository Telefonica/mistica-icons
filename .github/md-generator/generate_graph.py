...
def icons_equivalence_data_table(root_folder):
    ...
    markdown_table += "\n"
    markdown_table += "<sub>"
    markdown_table += "**Remaining:** The remaining percentage of icons after taking into account unique icons, icons with some equivalence, and icons with equivalence in all sets. This percentage represents the icons that do not fall into any of these categories."
    markdown_table += "</sub>"
    markdown_table += "\n\n"
