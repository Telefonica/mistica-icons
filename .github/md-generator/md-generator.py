...
total_telefonica = len(sorted(set.union(icons_telefonica)))
total_o2 = len(sorted(set.union(icons_o2)))
total_blau = len(sorted(set.union(icons_blau)))
...
o2_percent = (100 * total_o2) / total_icons
blau_percent = (100 * total_blau) / total_icons

# print(telefonica_percent)
# print(o2_percent)
# print(blau_percent)

telefonica_equivalence = str(int((int(telefonica_percent) * total_telefonica) / 100))
o2_equivalence = str(int((int(o2_percent) * total_o2) / 100))
blau_equivalence = str(int((int(blau_percent) * total_blau) / 100))

n_icons_telefonica = " " + "(" + str(total_telefonica) + " / " + telefonica_equivalence + ")"
n_icons_o2 = " " + "(" + str(total_o2) + " / " + o2_equivalence + ")"
n_icons_blau = " " + "(" + str(total_blau) + " / " + blau_equivalence + ")"

print(n_icons_telefonica)
