...
if __name__ == '__main__':
    ...
    dictionary = {}
    file_content = "## Mistica icons :art:" + BREAK + "This repo contains all icons that is working in [Mistica Design Libraries](https://github.com/Telefonica/mistica-design-libraries) now." + BREAK + "## Documentation" + BREAK + "You can find more information and how to use this repo in the [Wiki](https://github.com/Telefonica/mistica-icons/wiki)" + BREAK + "## Search in the repo" + BREAK + "The best way to search in this repo is using your browser's search engine:" + BREAK + "![Image of search engine](https://github.com/Telefonica/mistica-icons/blob/production/_resources/_imgs_github/github_img_1.png?raw=true)" + BREAK + "# Icons :mag: " + BREAK +  | global | name | SVG | PDF | | O2 | name | SVG | PDF |" + BREAK + "| :-: | :- | :-: | :-: | - | :-: | :- | :-: | :-: |" + BREAK
    for brand in files:
