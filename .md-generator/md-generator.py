...
if __name__ == '__main__':
    ...
    dictionary = {}
    file_content = "## Mistica icons"+ BREAK + "### What is this?" + BREAK + "This is the repo that contains all icons that is working in [Mistica Design Libraries](https://github.com/Telefonica/mistica-design-libraries) now." + BREAK + "The icons that there is here are **the only source of true** from the design team in icons." + BREAK + "If you have any question, please you can ask directly in the Slack channel `#designsystem`" + BREAK + "### Documentation" + BREAK + "You can find more information and how to use this repo in the [Wiki](https://github.com/Telefonica/mistica-icons/wiki)." + BREAK + "### Search in the repo" + BREAK + "The best way to search in this repo is using your browser's search engine (CMD + F):" + BREAK + "![Image of search engine](https://github.com/Telefonica/mistica-icons/blob/production/_resources/_imgs_github/github_img_1.png?raw=true)" + BREAK + "# Icons " + BREAK + "| global | name | SVG | PDF | | O2 | name | SVG | PDF |" + BREAK + "| :-: | :- | :-: | :-: | - | :-: | :- | :-: | :-: |" + BREAK
    for brand in files:
