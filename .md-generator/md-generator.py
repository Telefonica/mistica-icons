...
if __name__ == '__main__':
    ...
    dictionary = {}
    file_content = "# Esto es un H1" + BREAK + "# Esto es un H2" + BREAK + "[Y aquí tienes una guía de markdown link](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet)" + BREAK +"| global | name | SVG | PDF | | O2 | name | SVG | PDF |" + BREAK + "| :-: | :- | :-: | :-: | - | :-: | :- | :-: | :-: |" + BREAK
    for brand in files:
