...
| <sub><sup>ICON SET</sup></sub> | <sub><sup>CONCEPTS (615)</sup></sub> | <sub><sup>TOTAL (3269)</sup></sub> | <sub><sup>ALL EQUIVALENCE</sup></sub> | <sub><sup>SOME EQUIVALENCE</sup></sub> | <sub><sup>UNIQUE</sup></sub> | <sub><sup>MISSING</sup></sub> |
| :--------- | --------: | -----: | ----------: | -------------------: | -------------------: | ------------: |
