...
icnTags.creditcard = ["tag1", "tag2"];
icnTags.community = ["tag1", "tag2"];
icnTags.widget = ["tag1", "tag2"];
icnTags.shop = ["tag1", "tag2"];
icnTags.help = ["tag1", "tag2"];
icnTags.pin = ["tag1", "tag2"];
icnTags.settings_invitations = ["tag1", "tag2"];
icnTags.settings_support_chat = ["tag1", "tag2"];
icnTags.priority = ["tag1", "tag2"];
icnTags.priority_services = ["tag1", "tag2"];
icnTags.settings_rating = ["tag1", "tag2"];
icnTags.settings_tokens = ["tag1", "tag2"];
icnTags.device_setup = ["tag1", "tag2"];
icnTags.settings_device_support = ["tag1", "tag2"];
icnTags.settings_NT = ["tag1", "tag2"];
icnTags.settings_errorlog = ["tag1", "tag2"];
icnTags.settings_voicemail = ["tag1", "tag2"];
icnTags.order = ["tag1", "tag2"];
icnTags.bell = ["tag1", "tag2"];
