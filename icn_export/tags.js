...
// PROFILE
icnTags.lock = ["candado", "seguridad", "security"];
icnTags.notifications = ["notificacion", "aviso", "alerta"];
icnTags.phonebooks = ["agenda", "telefono"];
icnTags.profile = ["perfil", "tag2"];
icnTags.creditcard = ["tarjeta", "credito", "tag2"];
icnTags.community = ["comunidad", "tag2"];
icnTags.widget = ["tag1", "tag2"];
icnTags.shop = ["tienda", "tag2"];
icnTags.help = ["ayuda", "tag2"];
icnTags.pin = ["codigo", "tag2"];
icnTags.settings_invitations = ["ajustes", "invitacion"];
icnTags.settings_support_chat = ["ajustes", "conversacion"];
icnTags.priority = ["tag1", "tag2"];
icnTags.priority_services = ["servicios", "tag2"];
icnTags.settings_rating = ["ajustes", "tag2"];
icnTags.settings_tokens = ["ajustes", "tag2"];
icnTags.device_setup = ["dispositivo", "tag2"];
icnTags.settings_device_support = ["dispositivo", "soporte"];
icnTags.settings_NT = ["ajustes", "tag2"];
icnTags.settings_errorlog = ["ajustes", "error"];
...
// icn-submotiv-bars-purple
// icn-submotiv-bill
// icn-submotiv-cancel-green
// icn-submotiv-combo-magenta
// icn-submotiv-device
// icn-submotiv-dollar
// icn-submotiv-fiber
// submotiv-generic
// icn-submotiv-info
// icn-submotiv-movistar
// icn-submotiv-offer-tan
// icn-submotiv-search
// icn-submotiv-service
// icn-submotiv-technical
// icn-submotiv-vd-blue
// icn-submotiv-sim-black
// icn-submotiv-problemas-con-la-linea
// icn-submotiv-desvio-de-llamadas
// icn-submotiv-contestador
// icn-submotiv-rechazo-de-llamadas
// icn-submotiv-otros-servicios-de-llamadas
// icn-submotiv-datos-moviles
// icn-submotiv-estoy-en-el-extranjero
// icn-submotiv-conexion-segura
// icn-submotiv-aplicaciones-moviles
// icn-submotiv-otros
// icn-submotiv-mensajeria
// icn-submotiv-cobertura
// icn-submotiv-emocion
// icn-submotiv-configuracion-wifi
// icn-submotiv-smart-wifi
// icn-submotiv-problemas-con-el-antivirus
// icn-submotiv-configuracion-del-correo
// icn-submotiv-canales
// icn-submotiv-descodificador-y-mando
// icn-submotiv-configuracion-de-opciones
// icn-submotiv-series-peliculas-y-otros
// icn-submotiv-ultimos-7-dias-y-directo
icnTags.motiv_fijo = ["tag1", "tag2"];
icnTags.motiv_internet = ["tag1", "tag2"];
icnTags.motiv_tv = ["tag1", "tag2"];
icnTags.ticket_OB = ["tag1", "tag2"];
